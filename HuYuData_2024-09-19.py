...
# Print the results
print(f"Pfizer (PFE) Current Stock Price: {S:.2f}")
...
# Pfizer (PFE) Current Stock Price: 38.75
# Strike Price: 40
# Time to Expiration (years): 1.10
# Risk-Free Interest Rate: 0.05
# Volatility: 0.30
# Call Option Price: 2.12
# Put Option Price: 3.15